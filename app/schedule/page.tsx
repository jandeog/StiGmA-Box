...
export default function SchedulePage() {
  ...
  const [localCreditsDelta, setLocalCreditsDelta] = useState<number>(0);
  ...
  function computeFlags(s: Slot, dayHasMine: boolean) {
    ...
    if (
      ...
      return {
        ...
        lateCancelCreditLost: sf.lateCancelCreditLost,
      };
    }
            ...
            return (
              <div
                ...
                className={
                  ...
                  (isCoach ? 'cursor-pointer hover:border-emerald-500 hover:bg-emerald-950/30 transition-colors' : '')
                }
              >
